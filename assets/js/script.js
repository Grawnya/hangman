// set up the website and listen out for the 1 or 2 player option button - remove afterwards

// For 1 player: only 5 letter words - get JSON of all possible options and randomly select one
// For 2 player: prompt the user to enter a word (should I use prompt() or something else to fit aesthetic of page) - min 4, max 9 letters
...
// if the counter reaches 7, send message (either new html page or can I put temp box on page) that lets the user play again
